...
class AnnouncementAll {
  ...
  factory AnnouncementAll.fromJson(Map<String, dynamic> json) =>
      AnnouncementAll(
        announcement: List<AnnouncementElement>.from(
            json["announcement"].map((x) => AnnouncementElement.fromJson(x))),
      );
